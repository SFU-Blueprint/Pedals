      ...
      {nav === 'Shift' ? (
        <div className="flex w-full justify-between bg-pedals-lightgrey px-20 pt-[100px]">
          ...
          <div className="flex flex-grow items-center justify-end gap-2">
            <input className="uppercase" type="text" placeholder="Search Name" />
        ...
        <div>
          ...
          <div className="flex w-full flex-col bg-pedals-lightgrey">
            <div className="flex w-full items-center px-10">
              <hr className="flex-grow bg-gray-300" style={{ height: '3px', margin: '0 40px' }} />
            </div>
            <div className="flex w-full justify-between px-20 py-2">
              <div className="flex items-center gap-4 ">
                <label className="uppercase font-mono uppercase">
              ...
              <button type="submit" className="uppercase rounded-[30px] bg-yellow-400 uppercase">
